...
export default function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      />
      <Route path="/meus-casos" element={<RequireAuth><PlaceholderPage title="Meus casos" /></RequireAuth>} />
      <Route path="/turmas" element={<RequireAuth><PlaceholderPage title="Turmas" /></RequireAuth>} />
